...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="bg-[#101727] mt-20 px-20 py-10">
                <div className="footer sm:footer-horizontal justify-around">
                    <aside>
                        <div className='py-20 text-gray-500 text-lg space-y-3'>
                    ...
                    <nav className='text-gray-500 p-20'>
